...
const AllRooms = () =>{
    ...
    return(
        ...
        pt-28 md:pt-35 px-4 md:px-16 lg:px-24"> 
              ...
              {/* LEFT SIDE CONTAIN --> ROOMS DETAIL */}
              <div>
                  <div className="flex flex-col items-start text-left">
                    <h1 className="font-playfair text-4xl md:text-[40px]"> Hotel Rooms</h1>
                    <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-174">
                        Take advantage of our limited-time offers and special packages to enhance your stay and crete 
                ...
                {roomsDummyData.map((room)=>(
                    ...
                    border-b border-gray-300 last:pb-30 last:border-0">
                        ...
                        <div className="md:w-1/2 flex flex-col gap-2">
                            ...
                            onClick={()=> {navigate(`/rooms/${room._id}`) ; window.scrollTo(0,0) }} > {room.hotel.name}</p>

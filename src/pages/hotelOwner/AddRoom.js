...
const AddRoom = () =>{
    ...
    return(
        ...
        <form>
            ...
            details charefully and accurate room details, pricing, and amenities, to
            ...
            <div className="grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap">
                {Object.keys(images).map((key)=>(
                    <label htmlFor={`roomImage${key}`} key={key} >
                        <img className="max-h-13 opacity-80 cursor-pointer"
            ...
            <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
               ...
               <div>
                     ...
                     <input className="border border-gray-300 mt-1 rounded p-2 w-24"
                     value={inputs.pricePerNight} type='number' placeholder="0" 
            ...
            <div className="flex flex-col flex-wrap mt-1 max-w-sm text-gray-400">
                {Object.keys(inputs.amenities).map((amenity, index)=>(
                    <div key={index}>
                        <input type='checkbox' id={`amenity${index+1}`} checked={inputs.amenities[amenity]}

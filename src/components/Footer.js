...
const Footer = () =>{
    return(
        <div className='text-gray-500/80 pt-8 pb-10 px-6 md:px-16 lg:px-24 xl:px-32 bg-[#F6F9FC]'>
            ...
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                     Disover the world's most extraordinary places to stay, from boutique
            ...
            {/* COPYRIGHT MSG AND LINKS */}
            <hr className='border-gray-300 mt-8' />
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} BookAStay All rights reserved.</p>

...
const Testimonial = ()=>{
    return(
        ...
        bg-slate-50 pt-20 pb-30">
            <Title title='What Our Guests Say' subTitle='Disover why discenring travelers
            consistently chose BookAStay for their exclusive and luxurious accomadations around the world.' />

...
const FeaturedDestination = () =>{
    ...
    return(
        ...
        <Title title='Featured Destination' subTitle='Discover our handpickd selection
        of exceptional properties around the world, offering unparalled luxury and unforgettable experience.'/>

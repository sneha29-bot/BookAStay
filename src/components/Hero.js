...
const Hero = () => {
    return(
        ...
        bg-no-repeat bg-cover bg-center h-screen " >
             ...
             <p className="bg-[#49B9FF] /50 px-3.5 py-1 rounded-full mt-20"> Unforgettable Stays, Timeless Memories</p>
             
             <h1 className="font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px]
             font-bold md:font-extrabold max-w-xl mt-4">
             Escape to Your Perfect Destination</h1>
             
             <p className="max-w-130 mt-2 text-sm md:text-base ">Unparalleled luxary and comfort await at the world's most exclusive hotels and resorts. Start your journet today.</p>

             {/* FORM FOR SEACRH HOTEL*/}
